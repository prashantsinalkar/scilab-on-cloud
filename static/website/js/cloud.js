...
(function($) {
  ...
  $(document).ready(function() {
    ...
    /********************************************/
    $(document.body).on("change", "#revisions-diff", function(e) {
    ...
    $(document.body).on("click", "#bug-form-submit", function(e) {
      ...
      id_description = $(
        "#id_description").val();
      id_description = id_description.trim();
      id_email = $("#id_email").val();
      id_email = id_email.trim();
      if (issue_id == 0) {
        $('#id_issue').css({
